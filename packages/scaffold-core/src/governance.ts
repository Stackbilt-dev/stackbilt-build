...
export function hasComplianceDomain(domains: ComplianceDomains): boolean {
 ...
 */
export function buildGovernance(intention: string, result: ClassifyResult): GovernanceDocs {
