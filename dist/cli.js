...
async function run() {
    ...
    try {
        ...
        if (cmd === 'login')
            code = await loginCommand(options, args);
        else if (cmd === 'architect')
            code = await architectCommand(options, args);
        else if (cmd === 'classify')
            code = await classifyCommand(options, args);
        else if (cmd === 'run')
            code = await runCommand(options, args);
        else if (cmd === 'scaffold')
            code = await scaffoldCommand(options, args);
        else if (!cmd) {
